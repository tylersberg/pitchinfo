...
export const pitches = pgTable('pitches',
  {
    ...
    release_speed: numeric('release_speed'),
    release_pos_x: numeric('release_pos_x'),
    release_pos_z: numeric('release_pos_z'),
    ...
    pfx_x: numeric('pfx_x'),
    pfx_z: numeric('pfx_z'),
    plate_x: numeric('plate_x'),
    plate_z: numeric('plate_z'),
    on_3b: integer('on_3b'),
    on_2b: integer('on_2b'),
    on_1b: integer('on_1b'),
